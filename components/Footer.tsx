...
const socialLinks = [
  { label: "Instagram", href: "https://www.instagram.com/villasnstudiosbyritumbhara/" },
  { label: "LinkedIn", href: "https://www.linkedin.com/company/ritumbhara" },
  { label: "Airbnb", href: "https://www.airbnb.co.in/users/profile/1463553221581405024" },
];

export default function Footer() {
  return React.createElement("footer", { id: "footer", className: "bg-[#1A1A1A] text-white/80 pt-20 pb-8" },
    React.createElement("div", { className: "max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-2 lg:grid-cols-5 gap-12 mb-16" },
      ...
      React.createElement("div", null,
        React.createElement("h4", { className: "font-semibold text-white mb-4" }, "Connect"),
        socialLinks.map(function (s) {
          return React.createElement("a", { key: s.label, href: s.href, target: "_blank", rel: "noopener noreferrer", className: "block text-sm text-white/60 hover:text-white mb-2" }, s.label);
        })
      )
    ),
